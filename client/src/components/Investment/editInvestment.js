...
const EditInvestment = ({
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      investBy: loading || !investment.investBy ? "" : investment.investBy,
      date:
  ...
  const { amount, currency, investBy, date, project, image } = formData;
  ...
  const onSubmitHandler = (e) => {
    ...
    formData.append("investBy", investBy);
                  ...
                  <div className="bg-light border border-success">
                    <div>
                      <h3 className="bg-success text-center text-white p-4">
                        <Link to="/admin/viewinvestment" className="text-white">
