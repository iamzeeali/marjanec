...
const Navbar = (
                  ...
                  <ul className="navbar-nav ml-auto main-nav ">
                    ...
                    <li className="nav-item dropdown dropdown-slide">
                      ...
                      <div className="dropdown-menu dropdown-menu-right">
                        ...
                        <Link className="dropdown-item" to="/admin/viewproject">
                          View Project
                        </Link>
                      </div>
                    </li>
                    ...
                    <li className="nav-item dropdown dropdown-slide">
                      ...
                      <div className="dropdown-menu dropdown-menu-right">
                        ...
                        <Link
                          className="dropdown-item"
                          to="/admin/view-customerPay"
                        >
                          View Customer Payment
                        </Link>
                        <Link className="dropdown-item" to="/admin/addcustomer">
                          Add Customer
                        </Link>
                        <Link
                          className="dropdown-item"
  ...
  return (
    <Fragment>
      {!loading && <div>{isAuthenticated ? authLinksAdmin : guestLinks}</div>}
    </Fragment>
  );
};
