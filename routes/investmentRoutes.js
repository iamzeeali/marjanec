...
router
    .route("/getAll")
    .get(authController.restrictTo('admin'), investmentController.getAllInvestments)
router
    .route("/total/:id")
    .get(authController.restrictTo('admin'), investmentController.getTotalInvestments)

router
    .route("/Usertotal/:id")
    .get(authController.restrictTo('admin'), investmentController.getUsersTotalInvestments)
router
    .route("/monthTotal/:year")
    .get(authController.restrictTo('admin'), investmentController.getMonthInvestments)
router
    .route("/usermonthTotal/:year/:id")
    .get(authController.restrictTo('admin'), investmentController.getUserMonthInvestments)
router
    .route("/filter/:id")
    .get(authController.restrictTo('admin'), investmentController.getFilteredInvestments)
...
router
    .route("/getOverAllSum")
    .get(authController.restrictTo('admin', 'user'), investmentController.getOverAllSumInvestments)


//Restrict all router after this middleware to admin only- Authorization
router
    .route("/")
    .get(authController.restrictTo('user', 'admin'), investmentController.getUserInvestments)

router
    .route("/:id")
    .get(authController.restrictTo('user', 'admin'), investmentController.getInvestment)
    .delete(authController.restrictTo('user', 'admin'), investmentController.deleteInvestment)
